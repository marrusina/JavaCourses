...
//        try {
//            for (int i = 0; i < 25; i++) {
//                team.addPlayers(new FootballPlayer("NoName", PlayerRole.GOALKEEPER));
//            }
//        } catch (Exception ignore) {
//        }
//
...
//        FootballTeam t = new FootballTeam("1");
//        t.addPlayers(new FootballPlayer("ss", PlayerRole.DEFENDER));
//
//        Team<FootballPlayer> at = new Team<>("qq") {
//            @Override
...
//        };
//
////        at.addPlayer(new TennisPlayer("aa"));
//
//    }
//
//    @Test
//    public void scratchBook() {
//
//    }
//}
